...
The `./context/` directory is your context system. The context system is entirely filesystem-based. It contains critical information that you will **require** to successfully complete tasks as a personal assistant.
...
The `./context/` system is organized into the following subsystems:
